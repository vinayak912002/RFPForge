# top-k + reranking 
"""RFP-aware similarity search layer.

Responsibilities:
- validate query 
- Build metadata filters 
- Handle comparison queries(e.g., A vs B )
- Apply similarity threshold 
- Strructured retrieval logging
...
class RetrievalService:
    ...
    def __init__(
        ...
        """Inject dependencies (Do NOT  create them here)
        """
    ...
    def search(
        ...
        """"
        perform metadta-aware semantic retrieval.
        """
        ...
        if "vs" in query.lower():
            result =self._handle_comparison_query(
...
# ==============================================
    ...
    def _handle_single_query(
        ...
        docs_and_score =self.vector_store_service.similarity_search(
    ...
    def _handle_comparison_query(
        ...
        for part in parts:
            ...
            embedding = self.embedding_services.embed_query(cleaned)

            docs_and_scores=(
                self.vector_store_services.similarity_search(
    ...
    def _post_process(
        ...
        """Apply score threshold and format response.
        """
        results = []
        for doc, score in docs_and_scores:
            if score < 0.1:  # Skip low-scoring results
                continue
            results.append({
    ...
    def log_retrieval(
        ...
        logger.info(f"Retrieval Log: {log_payload}")
